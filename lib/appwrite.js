...
const validateClient = () => {
  ...
  if (client.config.project === 'team-x') {
    console.error('Appwrite project ID is using a placeholder (teamx). Set NEXT_PUBLIC_APPWRITE_PROJECT_ID to your actual Appwrite project ID.');
    return false;
  }
  return true;
};
...
const JOIN_TEAM_FUNCTION_ID = process.env.NEXT_PUBLIC_APPWRITE_JOIN_TEAM_FUNCTION_ID || '';

// Export with validation
export { account, client, databases, functions, storage, teams, validateClient, ID, Permission, Role, JOIN_TEAM_FUNCTION_ID };